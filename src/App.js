  ...
  return (
    <div className="App">
      <Page>
        ...
        />
        <Photo src={data.image} test="photo" />
        <Price
        ...
        />
        <RoomList list={data.roomTypes} title="Типи номерів" />
        <Description text={data.description} title="Опис" />
        <Details {...data.property_details} />
        <Description text={data.neighborhood_info} title="Про сусідів" />
